...
public class Assist {
    ...
    public <T> Assist andEq(String column, T value) {
        setRequires(new Assist().new WhereRequire("and " + column + " = ", value));
        return this;
    }
    ...
    public <T> Assist orEq(String column, T value) {
        setRequires(new Assist().new WhereRequire("or " + column + " = ", value));
        return this;
    }
    ...
    public <T> Assist andLike(String column, T value) {
        setRequires(new Assist().new WhereRequire("and " + column + " like ", value));
        return this;
    }
    ...
    public <T> Assist orLike(String column, T value) {
        setRequires(new Assist().new WhereRequire("or " + column + " like ", value));
        return this;
    }
    ...
    public <T> Assist andIn(String column, T value) {
        setRequires(new Assist().new WhereRequire("and " + column + " in (", value, " ) "));
        return this;
    }
    ...
    public <T> Assist orIn(String column, T value) {
        setRequires(new Assist().new WhereRequire("or " + column + " in (", value, " ) "));
        return this;
    }
    ...
    public <T> Assist andIn(String column, Object... values) {
        setRequires(new Assist().new WhereRequire("and " + column + " in (", " ) ", values));
        return this;
    }
    ...
    public <T> Assist orIn(String column, Object... values) {
        setRequires(new Assist().new WhereRequire("or " + column + " in (", " ) ", values));
        return this;
    }
    ...
    public <T> Assist customRequire(String prefix, T value, String suffix) {
        setRequires(new Assist().new WhereRequire(prefix, value, suffix));
        return this;
    }
    ...
    public static <T> WhereRequire<T> whereRequire(String condition, T value) {
        return new Assist().new WhereRequire(condition, value);
    }
    ...
    public static <T> WhereRequire<T> whereRequire(String condition, T value, String suffix) {
        return new Assist().new WhereRequire(condition, value, suffix);
    }
    ...
    public static <T> WhereRequire<T> whereRequire(String condition, String suffix, Object... values) {
        return new Assist().new WhereRequire(condition, suffix, values);
    }
