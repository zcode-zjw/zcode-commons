...
/**
 * @author zhangjiwei
 * @description 扇形交换机工作者
 * @date 2023/2/16 上午10:28
 */
public class FanoutExchangeWorkerQueue implements IExchangeWorkerQueue {
    ...
    public boolean support(RabbitPipelineQueue.ExchangeType exchangeType) {
        return RabbitPipelineQueue.ExchangeType.FANOUT.equals(exchangeType);
    }
    ...
    public void registerExchange(RabbitPipelineQueue rabbitMQueuePipeline) throws Exception {
        ...
        // 构造交换机对象
        DynamicRegisterBeanUtil.registerBean((ConfigurableApplicationContext) SpringContextUtils.getApplicationContext(), exchangeName, FanoutExchange.class, args);
