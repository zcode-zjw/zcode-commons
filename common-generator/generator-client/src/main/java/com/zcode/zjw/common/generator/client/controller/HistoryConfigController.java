...
import com.zcode.zjw.common.generator.client.models.HistoryConfigCVF;
import com.zcode.zjw.common.generator.client.options.HistoryConfig;
...
public class HistoryConfigController extends BaseController {
    ...
    public void initTable() {
        ...
        tdInfo.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONFIG_TD_INFO));
        TableColumn<HistoryConfigCVF, String> tdOperation = new TableColumn<HistoryConfigCVF, String>("操作");
        tdOperation.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONFIG_TD_OPERATION));
        ...
        StringProperty property = ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.HISTORY_CONFIG_TABLE_TIPS);
        ...
        lblTips.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONFIG_LBL_TIPS));
        LOG.debug("初始化配置信息完成!");
    ...
    public ObservableList<HistoryConfigCVF> getHistoryConfig() throws Exception {
        ...
        for (HistoryConfig tmp : item) {
            ...
            button.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONFIG_BTN_LOAD));
            ...
            button1.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONFIG_BTN_DATELE));
