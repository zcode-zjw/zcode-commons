...
import com.zcode.zjw.common.generator.client.models.TableAttributeEntityEditingCell;
import com.zcode.zjw.common.generator.client.options.DatabaseConfig;
import com.zcode.zjw.common.generator.client.options.EntityConfig;
...
public class SetEntityAttributeController extends BaseController {
    ...
    private void initLanguage() {
        tdIsCreate.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_CREATE));
        tdColumn.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_COLUMN));
        tdSqlType.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_SQL_TYPE));
        tdJavaType.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_JAVA_TYPE));
        tdField.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_FIELD));
        lblAddCustomProperty.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_LBL_ADD_CUSTOM_PROPERTY));
        lblKey.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_LBL_KEY));
        lblValue.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_LBL_VALUE));
        ...
        txtKey.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TXT_KEY));
        txtValue.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TXT_VALUE));
        chkOverrideFile.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_CHK_OVERRIDE_FILE));
        lblTemplate.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_LBL_TEMPLATE));
        cboTemplate.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_CBO_TEMPLATE));
        lblTableAlias.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_LBL_TABLE_ALIAS));
        txtTableAlias.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TXT_TABLE_ALIAS));
        lblPrimaryKey.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_LBL_PRIMARY_KEY));
        txtPrimaryKey.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_ENTITY_TXT_PRIMARY_KEY));
        chkFieldCamel.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_CHK_FIELD_CAMEL));
    }
