...
import com.zcode.zjw.common.generator.client.models.TableAttributeKeyValueTemplateEditingCell;
import com.zcode.zjw.common.generator.client.options.CustomConfig;
...
public class SetCustomController extends BaseController {
    ...
    private void initLanguage() {
        ...
        tdClassName.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_COMMON_CLASS_NAME));
        tdSuffix.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_COMMON_SUFFIX));
        tdPackageName.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_COMMON_PACKAGE_NAME));
        tdTemplate.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_COMMON_TEMPLATE_NAME));
        lblAddCustomProperty.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_LBL_ADD_CUSTOM_PROPERTY));
        lblPackageName.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_LBL_PACKAGE_NAME));
        lblClassName.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_LBL_CLASS_NAME));
        ...
        txtPackageName.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_TXT_PACKAGE_NAME));
        txtClassName.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_TXT_CLASS_NAME));
    ...
    public void loadConfig(CustomConfig config) {
        ...
        if (config != null && config.getTableItem() != null) {
            config.getTableItem().forEach(v -> {
                ...
                attribute.getTemplate().promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_CBO_TEMPLATE));
    ...
    public void onAddPropertyToTable(ActionEvent event) {
        ...
        comboBox.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.SET_CBO_TEMPLATE));
