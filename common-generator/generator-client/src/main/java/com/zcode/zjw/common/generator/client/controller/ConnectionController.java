...
import com.zcode.zjw.common.generator.client.common.DBUtil;
...
import com.zcode.zjw.common.generator.client.spi.DatabaseTypeNames;
...
public class ConnectionController extends BaseController {
    ...
    private void initLanguage() {
        lblConnName.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_CONN_NAME));
        lblConnURL.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_CONN_URL));
        lblListenPort.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_LISTEN_PORT));
        lblDBType.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_DB_TYPE));
        lblDBName.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_DB_NAME));
        lblUserName.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_USER_NAME));
        lblUserPwd.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_USER_PWD));
        lblDBCoding.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_DB_CODING));
        txtConnName.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_TXT_CONN_NAME));
        txtConnURL.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_TXT_CONN_URL));
        txtListenPort.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_TXT_LISTEN_PORT));
        cboDBType.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_CBO_DB_TYPE));
        txtDBName.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_TXT_DB_NAME));
        txtUserName.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_TXT_USER_NAME));
        txtUserPwd.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_TXT_USER_PWD));
        cboDBCoding.promptTextProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_LBL_DB_CODING));
        btnTestConn.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_BTN_TEST_CONN));
        btnSave.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_BTN_SAVE));
        btnCancel.textProperty().bind(ZcodeGeneratorRunner.LANGUAGE.get(LanguageKey.CONN_BTN_CANCEL));
    }
