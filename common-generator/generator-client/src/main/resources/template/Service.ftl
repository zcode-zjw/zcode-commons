...
public interface ${content.service.className} {
	 ...
	 * @return
	 */
	Result<?> ${content.service.item.select.value!}(${content.entity.className} value);
	 ...
	 * @return
	 */
	Result<?> ${content.service.item.selectById.value!}(${content.entity.primaryKeyAttr.javaType} id);
	<#else>
	 ...
	 * @return
	 */
	Result<?>${content.service.item.insertNotNull.value!}(${content.entity.className} value);
	 ...
	 * @return
	 */
	Result<?>${content.service.item.updateNotNull.value!}(${content.entity.className} enti);
	 ...
	 * @return
	 */
	Result<?>${content.service.item.deleteById.value!}(${content.entity.primaryKeyAttr.javaType} id);
	</#if>
}
