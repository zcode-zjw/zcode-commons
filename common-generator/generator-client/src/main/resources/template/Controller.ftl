...
public class ${content.controller.className} {
	...
	public Result<?> ${content.controller.item.f_find.value}(${content.entity.className} value) {
	...
	public Result<?> ${content.controller.item.f_getById.value}(@PathVariable(name="id") ${content.entity.primaryKeyAttr.javaType} id) {
	...
	public Result<?> ${content.controller.item.f_saveNotNull.value!}(${content.entity.className} value) {
	...
	public Result<?> ${content.controller.item.f_updateNotNull.value!}(${content.entity.className} value) {
	...
	public Result<?> ${content.controller.item.f_deleteById.value!}(@PathVariable(name="id") ${content.entity.primaryKeyAttr.javaType} id) {
